	...
	render() {
		...
		return createElement(
			...
			createElement(
				...
				children.map((child, key) => cloneElement(child, Object.assign({}, panelProps, { key })))
			)
		);
	}
}
...
export { Panel, TabList, Tab, ContextualTabs, MenuTab, ApplicationMenu, MenuGroup };export default Ribbon;
