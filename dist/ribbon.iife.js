...
class Ribbon extends react.PureComponent {
	...
	render() {
		...
		return react.createElement(
			...
			react.cloneElement(tablist, tabProps),
			react.createElement(
				'section',
				{ className: 'ribbon-content' },
				children.map((child, key) => react.cloneElement(child, Object.assign({}, panelProps, { key })))
			)
		);
	}
}
...
}((this.Ribbon = this.Ribbon || {}),React));
//# sourceMappingURL=ribbon.iife.js.map
